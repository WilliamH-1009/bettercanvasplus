...
function addDeadlineCalcDiv(combined) {
    ...
    title.innerText = "Deadline Calculation";
    div.appendChild(title);

    let assignments = getSortedAssignments(combined);

    let urgentCount = assignments.filter(a => a.isUrgent).length;
    let urgentInfo = document.createElement("p");
